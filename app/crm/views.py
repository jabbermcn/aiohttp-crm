...
from app.crm.schemes import ListUsersResponseSchema, UserGetResponseSchema, UserGetSchema, UserAddSchema, UserSchema
...
class ListUsersView(View):
    @docs(tags=['crm'], summary='Get users list', description='Get all users from database')
...
class GetUserView(View):
    @docs(tags=['crm'], summary='Get user by id', description='Get user by id from database')
